...
import { NSpace, NTag, NSelect, NCheckbox, NButton, NColorPicker, NInputNumber, NSlider } from 'naive-ui';
import { RasterStyle } from '/map/style';
import { GridLayer } from '/map/layer/raster/GridLayer';

export default {
    components: { NSpace, NTag, NSelect, NCheckbox, NButton, NColorPicker, NInputNumber, NSlider },
    props: [ ],
    setup(props) {
        ...
        const active = computed(() => {
            ...
            const style = layer.getStyle() as RasterStyle;
        ...
        function applyChanges() {
            ...
            const newStyle = new RasterStyle(attribute.value, transform_color(start_color.value), transform_color(end_color.value), ranges);
            layer.setStyle(newStyle);
        }

        return { active, applyChanges, start_color, end_color, attribute, classes, attribute_options }
    }
}
</script>
